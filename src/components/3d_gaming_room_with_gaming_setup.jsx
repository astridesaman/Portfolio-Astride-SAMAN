...
Command: npx gltfjsx@6.5.0 public\models\3d_gaming_room_with_gaming_setup.glb -T 
Files: public\models\3d_gaming_room_with_gaming_setup.glb [46.83MB] > C:\Users\astri\Downloads\projets\Portfolio-Astride-SAMAN\3d_gaming_room_with_gaming_setup-transformed.glb [3.71MB] (92%)
...
export function GamingRoom(props) {
  const { nodes, materials } = useGLTF('/3d_gaming_room_with_gaming_setup-transformed.glb')
  return (
...
useGLTF.preload('/3d_gaming_room_with_gaming_setup-transformed.glb')
